...
### Usage
To change render parameters you should see `include/config.h`. It is possible to render to a file or display the image
on the screen (see PREVIEW_MODE), but keep in mind that a quality render takes ~15-20 minutes at 5700x,
